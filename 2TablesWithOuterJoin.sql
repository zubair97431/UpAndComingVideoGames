...
CREATE TABLE steamPopularTags (
	...
	Animation_Modeling BOOLEAN NOT NULL, 
	...
	Design_Illustration BOOLEAN NOT NULL, 
...
SELECT * FROM steampopulartags; 

-- Table 2

CREATE TABLE steamGameDetails (
	Tag_Name VARCHAR NOT NULL,
	website_rating INT NOT NULL,
...
SELECT * FROM steamgamedetails;

-- Outer Join on Tag_Name

SELECT steampopulartags.Tag_Name
FROM steampopulartags
FULL OUTER JOIN steamgamedetails
ON steampopulartags.Tag_Name = steamgamedetails.Tag_Name;
...
-- FOREIGN KEY (name) REFERENCES steamGameDetails (name),
